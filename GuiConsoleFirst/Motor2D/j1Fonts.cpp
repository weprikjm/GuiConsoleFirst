...
SDL_Texture* j1Fonts::PrintConsolePassedText(const char* text, SDL_Color color, iPoint n,_TTF_Font* font)
{
	SDL_Texture* ret = NULL;
	SDL_Surface* surface = TTF_RenderText_Blended_Wrapped((font) ? font : default, text, color, n.x);
